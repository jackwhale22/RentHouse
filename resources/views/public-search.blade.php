...
@section('title', 'Jelajahi Kontrakan - Rent House')
            ...
            <div class="row mb-5">
                <div class="col-12">
                    <div class="glass-card filter-card">
                        ...
                        <form method="GET" action="{{ route('public.search') }}" class="filter-form">
                            <div class="row g-4">
                                <div class="col-md-4">
                            ...
                            @if(request()->hasAny(['search', 'lokasi', 'min_price', 'max_price']))
                                <div class="mt-4 text-center">
                                    <a href="{{ route('public.search') }}" class="glass-btn glass-btn-outline">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="results-title mb-1">
                                    ...
                                    @else
                                        <i class="fas fa-home me-2"></i>Semua Kontrakan Tersedia
                            ...
                            @if($kosList->total() > 0)
                                <div class="results-info">
                                    <small class="text-info">
                                        ...
                                        Menampilkan {{ $kosList->firstItem() }}-{{ $kosList->lastItem() }} dari {{ $kosList->total() }} hasil
                                    </small>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="glass-card kos-card h-100">
                                ...
                                <div class="kos-footer">
                                    <a href="{{ route('public.kos.show', $kos->id) }}" class="glass-btn glass-btn-primary w-100">
                    ...
                    <div class="col-12">
                        <div class="glass-card cta-card text-center">
                            ...
                            <div class="cta-actions">
                                ...
                                <a href="{{ route('login') }}" class="glass-btn glass-btn-outline">
